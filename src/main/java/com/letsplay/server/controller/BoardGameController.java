...
public class BoardGameController {
    ...
    public ResponseEntity<List<BoardGame>> listAllBoardGames(@RequestParam("group") Optional<Long> idGroup) {
    ...
    public ResponseEntity<?> getBoardGame(@PathVariable("id") long id) {
        ...
        if (boardGame == null) {
            ...
            return new ResponseEntity<>(new CustomErrorType("BoardGame with id " + id 
    ...
    public ResponseEntity<?> updateBoardGame(@PathVariable("id") long id, @RequestBody BoardGame boardGame) {
        ...
        return new ResponseEntity<BoardGame>(currentBoardGame, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deleteBoardGame(@PathVariable("id") long id) {
        ...
        if (boardGame == null) {
            ...
            return new ResponseEntity<>(new CustomErrorType("Unable to delete. BoardGame with id " + id + " not found."),
                    HttpStatus.NOT_FOUND);
        }
    ...
    public ResponseEntity<BoardGame> deleteAllBoardGames() {
